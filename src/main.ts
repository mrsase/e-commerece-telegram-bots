...
import {
  CLIENT_BOT_COMMANDS,
  COURIER_BOT_COMMANDS,
  MANAGER_BOT_COMMANDS,
} from "./config/bot-commands.js";
import {
  createClientBot,
  createCourierBot,
  createManagerBot,
} from "./infra/telegram/bots.js";
...
import {
  startScheduler,
  type Scheduler,
} from "./infra/scheduler/interval-scheduler.js";

function startPolling(
  botName: string,
  bot: ReturnType<typeof createClientBot>,
): void {
